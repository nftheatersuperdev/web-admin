  ...
  const pagesSection = [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          allowedPrivileges: [PRIVILEGES.PERM_CAR_VIEW],
          // allowedRoles: [ROLES.SUPER_ADMIN, ROLES.OPERATION, ROLES.CENTRE_OPERATION],
        },
        {
          id: 'left_menu__model',
    ...
    },
    {
      ...
      allowedPrivileges: [
        ...
        PRIVILEGES.PERM_COOKIE_CONSENT_VIEW,
        PRIVILEGES.PERM_ACCOUNT_ACTIVATION_VIEW,
      ],
      // allowedRoles: [
      //   ROLES.SUPER_ADMIN,
      //   ROLES.ADMIN,
      ...
      children: [
        ...
        },
        {
          ...
          allowedPrivileges: [PRIVILEGES.PERM_ACCOUNT_ACTIVATION_VIEW],
