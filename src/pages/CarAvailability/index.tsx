  ...
  return (
    <Page>
      ...
      <Card>
        ...
        <GridSearchSection className={classes.gridSearch} container spacing={1}>
          <Grid item xs={2}>
            <TextField
              disabled={isFetching}
              fullWidth
          ...
          >
            <TextField
              ...
              onKeyDown={(event) => {
                if (!filterSearchFieldError && filterSearchField !== '' && event.key === 'Enter') {
                  formik.handleSubmit()
                }
              }}
              InputProps={{
          ...
          <Grid className={classes.searchBar} item xs={2}>
            <DatePicker
              fullWidth
